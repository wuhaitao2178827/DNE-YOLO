...
def get_params():
    params = {
        'weight': '/root/apple-total-total/apple-total-total-original/weights/best.pt',
        'cfg': '/root/yolov8/ultralytics/cfg/models/v8/yolov8.yaml',
        'device': 'cpu',
        'method': 'GradCAM', # GradCAMPlusPlus, GradCAM, XGradCAM
        'layer': 'model.model[22]',
...
if __name__ == '__main__':
    ...
    model(r'/root/image/682.jpg', '/root/result')